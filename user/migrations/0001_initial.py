    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('DEACTIVE', 'Deactive'), ('ACTIVE', 'Active')], max_length=20)),
                ('is_active', models.BooleanField(default=True, max_length=20)),
                ('user_type', models.CharField(choices=[('STAFF', 'Staff'), ('STUDENT', 'Student'), ('EXAMCONTROLLER', 'Examcontroller'), ('ADMIN', 'Admin')], max_length=20)),
